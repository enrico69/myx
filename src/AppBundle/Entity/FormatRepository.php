 ...
 * FormatRepository
 *
 * This is the repository for the "Format" entities.
 * 
...
class FormatRepository extends \Doctrine\ORM\EntityRepository {
    ...
    /**
     * 
     * Return all the format sorted by name.
     * 
    ...
    public function findAllOrderedByName($intPage = 1) {
        ...
        $intRefValue = Format::QTY_FORMATS;
    ...
    /**
     * 
     * Return all the formats sorted by name, but WITHOUT pagination.
     * 
     * @param int $intPage is the number of the page of results
     * @return mixed array of Format entity. 
     * @throws \ErrorException
