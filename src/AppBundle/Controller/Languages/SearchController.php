...
class SearchController extends Controller {
    ...
    /**
     * Handle the search of languages.
     * 
    ...
    private function getResults($arrParams) {
        ...
        try {
            $arrResults = $this->getLanguageRepository()
                ->searchByName(
                    $arrParams['Request'],
                    $arrParams['Page']
                );
    ...
    private function getResultsTemplate($arrResults, $arrRequestData) {
        ...
        $languagesBar = $this->renderView('languages/languages-bar.html.twig');
        ...
        return $this->render(
            'pagination/paginationContainer.html.twig', array(
                ...
                'url_page' => 'language_search_results',
                'url_complement' => $strUrlComplement,
                'subview' => $languagesBar
                )
        );
    }
     ...
     * @author Eric COURTIAL.
     * @Route("/search/languages/results", name="language_search_results")
     */
